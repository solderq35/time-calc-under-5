...
function findTotal() {
  ...
  for (var i = 0; i < scoreunder5.length; i++) {
    if (parseFloat(scoreunder5[i].value))
      seconds_input =
        (210000 - parseInt(scoreunder5[i].value) * (100000 / 100000)) *
        (3 / 400);
    seconds_input_whole =
      (210000 - parseInt(scoreunder5[i].value) * (100000 / 100000)) *
      1000 *
  ...
  for (var i = 0; i < scoreover5.length; i++) {
    if (parseFloat(scoreover5[i].value))
      seconds_input2 =
        (175000 - parseInt(scoreover5[i].value) * (100000 / 100000)) * (3 / 50);
    seconds_input_whole2 =
      (175000 - parseInt(scoreover5[i].value) * (100000 / 100000)) *
      1000 *
      (3 / 50);
  }
